                ...
                switch (choice) {
                    case 1:
                        ...
                        if (input1 == 1) {
                            ...
                            double result = CalculatorLogic.add(in1, in2);
                            ...
                            double result = CalculatorLogic.add(in1, in2, in3);
                            System.out.println("result is" + result);
                    ...
                    case 2:
                        ...
                        if (input2 == 1) {
                            ...
                            double in1 = input.nextDouble();
                            double in2 = input.nextDouble();
                            double result = CalculatorLogic.sub(in1, in2);
                            System.out.println("result is" + result);
                            ...
                            double in2 = input.nextDouble();
                            double in3 =input.nextDouble();
                            double result = CalculatorLogic.sub(in1, in2, in3);
                            System.out.println("result is" + result);
                    ...
                    case 3:
                        ...
                        if (input3 == 1) {
                            ...
                            double in1 = input.nextDouble();
                            double in2 = input.nextDouble();
                            double result = CalculatorLogic.mul(in1, in2);
                            System.out.println("result is" + result);
                            ...
                            double in2 = input.nextDouble();
                            double in3 = input.nextDouble();
                            double result =CalculatorLogic.mul(in1, in2, in3);
                            System.out.println("result is" + result);
                    ...
                    case 4:
                        ...
                        if (input4 == 1) {
                            ...
                            double in1 = input.nextDouble();
                            double in2 = input.nextDouble();
                            double result = CalculatorLogic.div(in1, in2);
                           ...
                           checkResukt(result);
                            ...
                            double in2 = input.nextDouble();
                            double in3 = input.nextDouble();
                            double result = CalculatorLogic.div(in1, in2, in3);
                            checkResukt(result);
                    ...
                    case 5:
                        ...
                        if (input5 == 1) {
                            ...
                            double in1 = input.nextDouble();
                            double in2 = input.nextDouble();
                            double result = CalculatorLogic.pow(in1, in2);
                            System.out.println("result is" + result);
                            ...
                            double in2 = input.nextDouble();
                            double in3 = input.nextDouble();
                            CalculatorLogic.pow(in1, in2, in3);
